...
$test('subdirectory requests resolve to application routes',function()use($assert){$_SERVER['SCRIPT_NAME']='/mypro_website_php/public/index.php';$_SERVER['REQUEST_URI']='/mypro_website_php/services?ref=test';$assert(app_base_path()==='/mypro_website_php','Application base path was not detected');$assert(request_path()==='/services','Subdirectory was not removed from request path');$assert(app_path('/assets/app.css')==='/mypro_website_php/assets/app.css','Asset path did not retain application base');$_SERVER['SCRIPT_NAME']='/index.php';$_SERVER['REQUEST_URI']='/';});
